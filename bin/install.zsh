...
INCLUDE
	...
	function __install_claude() {
		...
		__link "$DOTFILES/claude/hooks/log-posttooluse.sh" "$CLAUDE_CONFIG_DIR/hooks/log-posttooluse.sh"
		__link "$DOTFILES/claude/hooks/notify.sh" "$CLAUDE_CONFIG_DIR/hooks/notify.sh"
